...
const svgContent = `<svg width="900" height="600" xmlns="http://www.w3.org/2000/svg">
  ...
  <text class="mono-text line7" x="30" y="380">
    <tspan class="scan-tag">[INFO]</tspan>
    <tspan class="label" dx="10">My TECH STACK</tspan>
    <tspan class="value" dx="10">Next.js, Flutter, Django, GCP, Docker, Alpine Linux, GraphQL/RESTful API, M.E.R.N, MongoDB, Supabase, Redis </tspan>
  </text>
